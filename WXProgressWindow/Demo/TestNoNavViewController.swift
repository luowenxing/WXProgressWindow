...
class TestNoNavViewController:UIViewController,ProgressWindowManagerDelegate {
    ...
    private lazy var progressManager:ProgressWindowManager! = ProgressWindowManager(rootViewController: self, delegate:self)
